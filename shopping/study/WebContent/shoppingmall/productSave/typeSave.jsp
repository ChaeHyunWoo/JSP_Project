...
<body>
	<center>
		<table width="600" border="2" cellpadding="0" cellspacing="0"
			...
			<tr height="40">
				<td style="padding-left: 20px"><b>종류 저장</b></td>
			</tr>
		</table>
		<br />
			...
			<table width="600" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<td width="460" style="padding-left: 10px;"><input type="text"
						name="typeName" size="35" maxlength="20" class="boxTF" /></td>
				</tr>
				<tr>
			...
			<table width="600" border="0" cellpadding="0" cellspacing="3"
				...
				<tr align="center">
					<td height="40"><input type="button" value=" 등록하기 "
						class="btn2" onclick="sendType();" /> <input type="reset"
						value=" 다시입력 " class="btn2"/> <input
