			...
			<table>
				...
				<tbody>
					...
					<tr>
						...
						<font color="red">성명은 최대 4자까지 가능합니다</font>
						</td>	
					</tr>
					<tr>
						<th>비밀번호</th>
					...
					<tr>
						...
						<input type="text" id="roadFullAddr" name="roadFullAddr" size="60" />
					...
					<!-- <tr>
						<th>주소</th>
						<td class="txt_color">
							<p><input type="text" name="zipcode" id="zipcode" value="" size="8" class="type03" readonly="">										
							<a href="javascript:findzipcode(&#39;/nhome&#39;, &#39;setAddrsub&#39;);" class="btn-type post">우편번호 검색</a></p>
							<button type="button" class="btn-type post" onclick="goPopup();">주소검색</button>
							<p><input type="text" name="addr1" id="addr1" value="" size="70" class="type04" readonly="readonly"> </p>
							<p><input type="text" name="addr2" id="addr2" value="" size="50" class="type04">
...
<script type="text/javascript">
	...
	function idpwCheck() {
		...
		if(!f.roadFullAddr.value) {
			...
			alert("주소를 입력하세요!");
			document.form.roadFullAddr.focous();
			return;
		}
